...
var level2 = [
    ...
    [ 0,        4000,  250,         'step'                 ],
    [ 6000,     13000, 400,         'ltr'                  ],
    [ 10000,    16000, 200,         'circle'               ],
    [ 17800,    20000, 250,         'straight', { x: 50  } ],
    [ 18200,    20000, 250,         'straight', { x: 90  } ],
    [ 18200,    20000, 250,         'straight', { x: 10  } ],
...
var playGame = function() {
    ...
    // ganado el juego
    board.add(new Level(level1, seguir));
...
var seguir =function(){
    Game.setBoard(3,new TitleScreen("Level 2", "press fire to next level", play2));
};
