...
var Game = new function() {                                                                  
    ...
    var KEY_CODES = { 37:'left', 39:'right', 32 :'fire', 66: 'fireball_left', 78: 'fireball_right' };
    this.keys = {};
...
var GameBoard = function() {
    ...
    _.each(obj,function(obj){obj[funcName].apply(obj,args)});
    ...
    this.detect = function(func) {
        var obj = this.objects;
        return _.find(obj,function(obj) { return func.call(obj) }) || false;
...
Sprite.prototype.draw = function(ctx) {
    SpriteSheet.draw(ctx,this.sprite,this.x,this.y,this.frame,this.dw, this.dh);
}
